...
export default {
  ...
  'settings.accent': '色',
  'settings.completed': '完了したタスク',
  'settings.completedHint': '既定では非表示です。進捗率や件数、月ごとの集計には引き続き含まれます。',
  'settings.completedShow': '完了したタスクを表示する',
  'settings.completedHide': '完了したタスクを隠す',
  'settings.access': '編集',
